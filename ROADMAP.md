...
| Hosted Android emulator matrix | **Implemented; API 31/34 first-launch frames captured, rerun pending after Flutter semantics selector fix** |
...
| API 31/34 hosted emulator smoke suite | **Active; both APIs reached first launch, Flutter-semantics selector rerun pending** | Launch, settings write/relaunch, local WorkManager task, pipeline expansion, background/restore and evidence capture |
