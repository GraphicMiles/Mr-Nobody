...
| Hosted Android emulator matrix | **Implemented; API 31/34 instrumentation reached the app, rerun pending after deterministic first-launch reset/evidence fix** |
...
| API 31/34 hosted emulator smoke suite | **Active; both APIs reached the app, auto-backup-safe first-launch rerun pending** | Launch, settings write/relaunch, local WorkManager task, pipeline expansion, background/restore and evidence capture |
