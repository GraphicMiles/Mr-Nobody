...
| Hosted Android emulator matrix | **Implemented; API 31/34 instrumentation reached the app, rerun pending after viewport-safe first-launch assertion fix** |
...
| API 31/34 hosted emulator smoke suite | **Active; instrumentation reached first launch on both APIs, corrected rerun pending** | Launch, settings write/relaunch, local WorkManager task, pipeline expansion, background/restore and evidence capture |
